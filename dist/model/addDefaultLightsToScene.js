...
export const addDefaultLightsToScene = (scene) => {
    {
    ...
    // left
    {
        ...
        light.diffuse = c3(Colors.builder({ color: "red" }).lighten(0.8).toString());
        light.intensity = 3;
    }
    // right
    {
        ...
        light.diffuse = c3(Colors.builder({ color: "blue" }).lighten(0.8).toString());
        light.intensity = 1;
    }
    // front
    // {
...
//# sourceMappingURL=addDefaultLightsToScene.js.map