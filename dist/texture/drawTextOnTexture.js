...
export const drawTextOnTexture = (texture, text, options = {}) => {
    const { backgroundColor, outline = true, color = "black", fontFamily = "monospace", fontStyle = "bold", outlineColor = Colors.builder({ color: "white" }).alpha(0.1).toString(), textureSize = Math.min(texture.getSize().width, texture.getSize().height), } = options;
...
//# sourceMappingURL=drawTextOnTexture.js.map